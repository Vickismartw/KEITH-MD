...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/5f0e777415fb09b36f30b.jpg" ; // SET LOGO FOR IMAGE 



global.devs = "254748387615" // Developer Contact
...
module.exports = {
  ...
  caption : process.env.CAPTION || "KEITH MD" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
